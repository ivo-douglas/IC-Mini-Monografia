...
\section{Contextualizar e definir o problema atacado pelo produto e/ou tecnologia de informação alvo} \label{sec:firstpage}
	...
	Na pandemia em que vivemos surgiram vários problemas e um deles, o desemprego. Para isso, foi criado o auxílo emergencial pela caixa para que fosse concendido um valor de R\$ 600, somenete para aqueles que sofrem desse desemprego ou ainda da deficiência econômica causada pela pandêmia.
...
\subsection{Problemas Solucionados}
	No entanto, este programa trouxe outro problema, que é a superlotação e grandes filas em agências para o saque ou ainda para o cadastramento para a análise do auxílio emergêncial. Com isso, em 23 de maio, a caixa lançou o aplicativo, Caixa | Auxílio Emergêncial, para que esses problemas possam ser resolvídos.

\subsection{Detalhes do aplicativo}
	Portanto, este é um aplicativo que compreende o négocio do tipo G2C, propondo um contato mais direto e imediato entre o governo e às pessoas que buscam pelo auxílio emergencial. Também exige a conexão com a internet para saques e cadastramentos.
\subsection{Problemas causados}
	Embora as filas tenham sidas reduzidas ao mínimo, problemas de cunho ético foram surgindo. Trata-se de pessoas burlando o sistema para receber o auxílio, isto é, mesmo estas que não fazem parte do grupo que é contemplado pelo programa. Como foi o caso do filho de William Bonner, que teve sua identidade roubada para fazer registro no auxílio emergêncial e teve e mesmo assim, teve o status aprovado.
\linebreak
\linebreak
	Então percebemosos que, além do sistema não ser muito confiável na analise dos dados(pois sendo filho de William Bonner, muito provavelmente não estaria no grupo de necessitados do auxílio emergência e mesmo assim teve o status de aprovado). Ainda não é muito eficiente na detecção de fraudes, onde um cidadão pode-se passar por outro, a fim de se beneficiar ou ainda abusar do sistema do auxílio emergêncial. 
